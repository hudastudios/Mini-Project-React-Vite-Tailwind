    ...
    return (
        <div
            ...
            <section
                ...
                <div className="self-stretch flex flex-row items-start justify-between p-6 gap-[20px] mq700:flex-wrap">
                    <div
                    ...
                    <div
                        className="w-[298px] flex flex-row items-start justify-start gap-[33.3px] text-[8px] text-main-color-white mq450:gap-[17px] mq750:w-0 mq750:pr-24">
                        ...
                        <div className="h-[42px] flex flex-col items-start justify-start pt-0.5 px-0 pb-0 box-border">
                            <div className="w-[1.5px] h-[41.5px] relative box-border border-r-[1.5px] border-solid border-lavender mq750:hidden"></div>
                        </div>
                ...
                <DetailUserSection></DetailUserSection>
            </section>
        </div>
    )
};
